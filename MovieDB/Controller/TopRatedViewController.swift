...
//            if let headerView = topRatedCollectionView.dequeueReusableSupplementaryView(ofKind: kind, withReuseIdentifier: "footer", for: indexPath) as? FooterCollectionReusableView {
//                headerView.spinnerLoadMoreData.startAnimating()
//                return headerView
//            }
//
//        default:
